...
const CPUCard = ({ cpu, setSelectedHardwares }) => {
  const handleAddWithAnimation = (e) => {
    ...
    const targetElement = document.getElementById('part-image-cpu');
  ...
  return (
    ...
    >
      <div className="w-16 h-16 bg-gray-100 dark:bg-slate-700 rounded overflow-hidden flex items-center justify-center">
        <img
          src={cpu.img || "/img/cpu_default.jpg"}
      ...
      <div className="flex-1">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400">
          {cpu.core} cores • {cpu.thread} threads • {cpu.tdp}W
        </p>
      </div>
